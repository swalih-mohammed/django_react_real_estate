...
SimpleFooter.defaultProps = {
  company: { href: "laamacademy.com", name: "Laam Academy" },
  links: [
    { href: "laamacademy.com", name: "Laam Academy" },
    { href: "laamacademy.com", name: "About Us" },
    { href: "laamacademy.com", name: "Blog" },
    { href: "laamacademy.com", name: "License" },
  ],
  light: false,
};
